...
| **למידה** | מה בהצעה ובמחיר החזיק, ומה ויתר? | **חלקי.** האומדן והפנקס מתכיילים בתוך POST-CALL, ורק אחרי חמש מסירות. אין היום מעבר חזרה ל-PRE-CALL |
...
- **לולאת הלמידה לא סוגרת מעגל מלא.** הפנקס מכייל את האומדן בתוך POST-CALL ומדווח על העסקאות שלכם. תוצאת עסקה אינה חוזרת ל-PRE-CALL ואינה משנה את ההכנה לשיחה הבאה.
