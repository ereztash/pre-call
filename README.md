...
הצעה שלא נסגרת היא העבודה היקרה ביותר שעצמאי עושה — שעה בשיחה, שעתיים בכתיבה, ואפס. שני רבדים מתוך הבעיה הזאת בנויים כאן: **המחיר**, שנגזר ממספר שהלקוח עצמו אמר ומצוטט עם המשפט שממנו נלקח, ו**המסמך**, שהגבולות והתנאים בו נגזרים מאותן תשובות.

לפי אותה תכלית, **עיצוב חזותי — גופן, אורך, מבנה — יושב בתחתית סדר העדיפויות ולא נבנה.** אין לו אפקט מדוד על סגירת עסקאות שאפשר לצטט, ומהירות התגובה והמעקב אחרי הצעה ששקטה קודמים לו.

**ומה שלא נטען כאן: שהכלי מעלה את שיעור הסגירה.** שיעור הוא פרופורציה. הרמה של עשר נקודות דורשת כ-660 הצעות מוכרעות כדי בכלל להיראות — אחת-עשרה שנה אצל מי ששולח חמש בחודש. מה שכן מובטח הוא מה שנבדק כבר בשימוש הראשון: מהשיחה למסמך מתומחר שאפשר להגן עליו בחדר. `assets/pc-history.js` מסרב לטעון יותר מזה גם על המסך, ולא רק כאן.
