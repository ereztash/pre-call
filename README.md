...
**סטטוס.** הזרימה נבדקה מקצה לקצה, כולל המסע המלא בשלושה מנועי דפדפן. **טרם השלים אותה משתמש זר:** שלושת המבקרים הראשונים נחסמו בקיר login של פריסת preview, ו-[`docs/first-ten.md`](docs/first-ten.md) מחזיק את הפרוטוקול לעשרה הבאים. זו נקודת ההתחלה של הפיילוט, לא תוצאה שלו.
