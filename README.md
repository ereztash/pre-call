...
| **מקור המספר נגזר, לא נשאל** | הלקוח נקב מעצמו → `unprompted`. אחרי שאלה שכיוונה לשם → `prompted`. אין ציטוט של הלקוח → `mine` |
...
assets/*.test.js      268 בדיקות שרצות ב-Node בלי דפדפן
