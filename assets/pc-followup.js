/* ============================================================
   ...
   There is no server here and there never will be, so this cannot send
   anything. What it can do is hand the operator a trigger that lives
   somewhere which does notify them: their own calendar. An .ics file is
   the whole mechanism — no account, no permission prompt, no background
   worker, and it keeps working on a phone with the tab long closed.
